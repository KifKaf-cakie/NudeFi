      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="flex border-b border-gray-700 mb-8">
          ...
          >
            ...
            {activeTab === 'content' && (
              <span className="absolute bottom-0 left-0 w-full h-[2px] bg-pink-500"></span>
            )}
          </button>
          <button
            className={`px-6 py-3 font-medium relative ${
        ...
        {activeTab === 'content' && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {content.map((item) => (
              <div
                key={item.id}
                className="bg-gray-800 rounded-lg overflow-hidden shadow-md border border-pink-500/10 hover:border-pink-500/30 transition-all hover:shadow-lg hover:shadow-pink-500/5 group"
              >
        ...
        {activeTab === 'comments' && (
          <div className="space-y-6">
            {comments.map((comment, index) => (
              <div
                key={index}
                className="bg-gray-800 rounded-lg p-6 border border-pink-500/10"
              >
